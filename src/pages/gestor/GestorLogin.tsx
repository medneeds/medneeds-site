...
import { Users, Mail, Lock, ArrowRight, ArrowLeft } from "lucide-react";
...
export default function GestorLogin() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const canAccess = await groupService.canAccessGestor(user.id);

      if (!canAccess) {
        await signOut();
        toast({
          title: "Acesso negado",
          description: "Você não tem permissão para acessar o painel de gestão.",
          variant: "destructive",
        });
        setLoading(false);
        return;
      ...
      toast({
        ...
        description: "Redirecionando para o painel de escalas...",
      });
        ...
        >
          ...
          <div className="bg-slate-800/50 backdrop-blur-xl border border-slate-700 rounded-2xl p-5 sm:p-8 shadow-2xl">
            ...
            <div className="text-center mb-6 sm:mb-8">
              ...
              <h1 className="text-xl sm:text-2xl font-bold text-white">Portal do Gestor</h1>
              <p className="text-slate-400 mt-1 text-sm sm:text-base">Gestão de escalas e equipes</p>
            </div>
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <Input
                    id="email"
                    type="email"
                    placeholder="gestor@instituicao.com"
                    value={email}
            ...
            <p className="text-center text-xs text-slate-500 mt-4">
              Medneeds © 2025 • Portal de Gestão
            </p>
          </div>
        </motion.div>
      </div>
