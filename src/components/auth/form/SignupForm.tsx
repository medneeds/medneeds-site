...
import { signupSchema, SignupFormValues } from "@/pages/auth/schema/Auth.schema.ts";
import { UF_OPTIONS } from "@/utils/constants.ts";
import {IFormProps} from "@/types/form.types.ts";

interface SignupFormProps extends IFormProps<SignupFormValues> {
    defaultCpf?: string;
    defaultEmail?: string;
}

export function SignupForm({ loading, onSubmit, defaultCpf = '', defaultEmail = '' }: SignupFormProps) {
