...
import { Activity, Stethoscope, Loader2, FileText, Save } from "lucide-react";
...
import { JobModality, ClinicalArea } from "@/types/api.types";

import { NewJobFormData, newJobSchema } from "../schemas/NewJobModal.schema";
import { NewJobModalProps, PaymentMethod } from "./types";
          ...
          <div className="flex items-center justify-between">
            ...
            {!isEditing && (
              <Button
                variant="ghost"
                size="sm"
                className="gap-1.5 text-primary mr-6"
